...
__DEFINE__(1564284804121, function(require, module, exports) {
/* eslint-disable */
...
!(function () {
  ...
  var api = {
     ...
     * @param {Object} ecc ecc
     */
    draw: function (str, canvasId, $this, ecc) {
      let that = this
      const query = wx.createSelectorQuery()
      query.select('#' + canvasId).boundingClientRect()
      query.exec(function (res) {
        that._draw(str, canvasId, res[0].width, res[0].height, $this, ecc)
      })
    }
  }
  module.exports = { api }
...
return __REQUIRE__(1564284804121);
})()
